...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-76-2} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-89-1} 
...
\hlkwd{hist}\hlstd{(residuals,} \hlkwc{main} \hlstd{=} \hlstr{""}\hlstd{,} \hlkwc{xlab} \hlstd{=} \hlstr{"Residuals"}\hlstd{)}
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-98-1} 
...
Although the interpretation of such a model can be different, the method of performing a regression on a variable with two levels is the same.  
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{summary}\hlstd{(}\hlkwd{lm}\hlstd{(}\hlkwd{log}\hlstd{(wdi.2011}\hlopt{$}\hlstd{inf.mort)}\hlopt{~}\hlstd{wdi.2011}\hlopt{$}\hlstd{sanit.access))}
\end{alltt}
\begin{verbatim}
## 
## Call:
## lm(formula = log(wdi.2011$inf.mort) ~ wdi.2011$sanit.access)
## 
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -1.42680 -0.48562  0.02123  0.40440  1.70517 
## 
## Coefficients:
##                        Estimate Std. Error t value Pr(>|t|)    
## (Intercept)            4.930188   0.119070   41.41   <2e-16 ***
## wdi.2011$sanit.access -0.029873   0.001568  -19.05   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6107 on 161 degrees of freedom
##   (2 observations deleted due to missingness)
## Multiple R-squared:  0.6926,	Adjusted R-squared:  0.6907 
## F-statistic: 362.8 on 1 and 161 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
