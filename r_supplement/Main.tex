...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{samp.df}\hlopt{$}\hlstd{weights}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{samp.df}\hlopt{$}\hlstd{weights[}\hlnum{1}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] 210
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{samp.df}\hlopt{$}\hlstd{weights_kg} \hlkwb{=} \hlstd{samp.df}\hlopt{$}\hlstd{weights}\hlopt{/}\hlnum{2.2}
\hlstd{samp.df}
\end{alltt}
\begin{verbatim}
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-124-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-128-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-137-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-141-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-149-1} 
