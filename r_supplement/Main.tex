...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-80-2} 
...
In Chapter 6, the dataset \texttt{statins} was introduced when visually understanding the assumptions of simple linear regression.  It will again be used in this chapter to understand the idea of multiple linear regression.
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-106-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-110-1} 
