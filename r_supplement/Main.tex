...
Often times, it is useful to combine two matrices or a matrix and a vector into one larger matrix.  This can be done using the function \textit{cbind()} or \textit{rbind()}.  These work similarly to the concatenation function \textit{c()}, but with multiple dimensions.  The function takes as input the elements to be combined in the order of choice, separated by commas.  For example, in the example below, an extra column representing smoking status is added to the matrix.  
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-86-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-104-2} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-120-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-125-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-129-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-130-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-134-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-135-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-136-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-145-1} 
